...
export const grammar = {
    ...
    "lex": {
        "rules": [
            ...
            ["\\*", "return 'TIMES'"],
            ["\\/", "return 'DIV'"],
            ["[a-zA-Z][a-zA-Z0-9]*", "return stringToken(yytext)"],
            ["^$", "return 'ε'"],
        ]
    },
    ...
    "bnf": {
        ...
        "programa": [
            ["", "$$ = new Program(new Location(@1.first_line , @1.last_line, @1.first_column, @1.last_column));"],
        ...
        "funcion": [
            ["FUN ID LPAREN lista_paramametros RPAREN COLON tipo bloque", "$$ = new Fun($2, $7, $4, $8, new Location(@1.first_line , @8.last_line, @1.first_column, @8.last_column));"]
        ],


        "procedimiento": [
            ["FUN ID LPAREN lista_paramametros RPAREN bloque", "$$ = new Fun($2, new UnitType(), $4, $6, new Location(@1.first_line , @6.last_line, @1.first_column, @6.last_column));"]
        ],
        ...
        "instruccion": [
            ["ID ASSIGN expresion", "$$ = new StmtAssign($1, $3, new Location(@1.first_line , @3.last_line, @1.first_column, @3.last_column));"],
        ...
        "parametro": [
            ["ID COLON tipo", "$$ = new Parameter($1, $3, new Location(@1.first_line , @3.last_line, @1.first_column, @3.last_column));"]
        ],

        "lista_no_vacia": [
            ["parametro", "$$ = new Arrays($1)"],
        ...
        "bloque": [
            ["LBRACE lista_instrucciones RBRACE", "$$ = new Block($2, new Location(@1.first_line , @3.last_line, @1.first_column, @3.last_column))"]
        ],
        ...
        "expresion_atomica": [
            ["ID", "$$ = new ExprVar($1, new Location(@1.first_line , @1.last_line, @1.first_column, @1.last_column))"],
        ...
        "expresion_multiplicativa": [
            ["expresion_multiplicativa TIMES expresion_atomica", "$$ = new ExprMul($1,$3, new Location(@1.first_line , @3.last_line, @1.first_column, @3.last_column))"],
            ["expresion_atomica", "$$ = $1"]
        ],

        "expresion_aditiva": [
            ["expresion_aditiva PLUS expresion_multiplicativa", "$$ = new ExprAdd($1,$3, new Location(@1.first_line , @3.last_line, @1.first_column, @3.last_column))"],
        ...
        "expresion_relacional": [
            ["expresion_aditiva LE expresion_aditiva", "$$ = new ExprLe($1,$3, new Location(@1.first_line , @3.last_line, @1.first_column, @3.last_column))"],
        ...
        "expresion_logica_atomica": [
            ["NOT expresion_logica_atomica", "$$ = new ExprNot($2, new Location(@1.first_line , @2.last_line, @1.first_column, @2.last_column))"],
            ["expresion_relacional", "$$ = $1"]
        ],

        "expresion_logica": [
            ["expresion_logica AND expresion_logica_atomica", "$$ = new ExprAnd($1, $3, new Location(@1.first_line , @3.last_line, @1.first_column, @3.last_column))"],
